<?php
class horarios_servicio_model extends Base_Model{
	...
	public function db_get_servicio_user($id_servicio){
		// DB Info		
		$tbl = $this->tbl;
		// Query
		$query = "SELECT COUNT(*) num_servicios FROM (
				  SELECT id_servicio FROM $tbl[nutricion_ciclo_receta] WHERE id_servicio = $id_servicio) s";
